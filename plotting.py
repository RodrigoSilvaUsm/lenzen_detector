...
def plotting(effiNormal, R, L, I, J):
    dx = 2 * R / (I+2)
    dz = L / (J+2)
    ...
    #effiNormal = effi.efficiency(R,L,N,M,I,J,top=False, range_particle=40e-3)
    contours = plt.contour(EQUIS, ZETA, effiNormal, 20 ,cmap='viridis')
